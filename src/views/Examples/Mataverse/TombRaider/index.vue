...
import { useThree, useGround } from './hook'
// 导入组件
...
// 导入常量
import { firstPersonPerspectiveCamera } from './constants'
...
const handleMouseMove = (event: any) => {
  ...
  } else if (cameraEmptyBox.rotation.x < Math.PI / 100) {
    cameraEmptyBox.rotation.x = Math.PI / 100
  }
}
